...
public interface FoodService {
     ...
     * @return int
     */
    int InsertFood(String  name,int sellerID,String foodIntroduction,String species,double price);
    ...
    void update(String name, int sellerID, String foodIntroduction, String species, double price);
