...
import com.coding.demo.service.FoodService;
...
public class FoodServiceImpl implements FoodService {
    ...
    @Override
    public int InsertFood(String name, int sellerID, String foodIntroduction, String species, double price) {
...
//            }
    ...
    @Override
    public void update(String name, int sellerID, String foodIntroduction, String species, double price) {
        foodMapper.update(name,sellerID,foodIntroduction,species,price);
    }
}
